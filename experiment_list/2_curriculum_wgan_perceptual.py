...
def begin(state, loaders):
  ...
  G_state = torch.load('/home/s2125048/thesis/model/20200626_093028/wgan_perceptual_style_faceparsing/epoch90_G.pt',map_location='cuda:0' if torch.cuda.is_available() else 'cpu')
